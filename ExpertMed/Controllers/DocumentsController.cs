    ...
    public class DocumentsController : Controller
    {
       ...
       .Text(text =>
       {
        ...
        public async Task<IActionResult> LaboratoryDoc(int consultationId)
        {
            ...
            return new ViewAsPdf("LaboratoryDoc", viewModel)
            {
                FileName = "Receta.pdf",
                PageOrientation = (Rotativa.AspNetCore.Options.Orientation?)Rotativa.Core.Options.Orientation.Landscape,
                PageSize = (Rotativa.AspNetCore.Options.Size?)Rotativa.Core.Options.Size.A4,
                CustomSwitches = "--print-media-type --viewport-size 1280x1024"
            };
        }
        ...
        public IActionResult ImageDoc()
        {
            ...
            {
                PageSize = (Rotativa.AspNetCore.Options.Size?)Rotativa.Core.Options.Size.A5,
                PageOrientation = (Rotativa.AspNetCore.Options.Orientation?)Rotativa.Core.Options.Orientation.Landscape,
            };
        }
    }

...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Patient>(entity =>
        {
            ...
            entity.HasOne(d => d.PatientProvinceNavigation).WithMany(p => p.PatientPatientProvinceNavigations)
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(e => e.UsersEstablishmentAddress)
                .HasMaxLength(255)
                .HasColumnName("users_establishment_address");
            entity.Property(e => e.UsersEstablishmentEmissionpoint)
                .HasMaxLength(4)
                .HasColumnName("users_establishment_emissionpoint");
            entity.Property(e => e.UsersEstablishmentName)
                .HasMaxLength(255)
                .HasColumnName("users_establishment_name");
            entity.Property(e => e.UsersEstablishmentPointofsale)
                .HasMaxLength(4)
            ...
            entity.Property(e => e.UsersSequentialBilling).HasColumnName("users_sequential_billing");
